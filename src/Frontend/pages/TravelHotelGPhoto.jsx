...
import Gallery from '../Components/PhotoGallery/TravelHotelPhoto'
...
export default function TravelHotelGPhoto() {
  return (
    <>
    <Header/>
    <Seo
      ...
      />
      <link rel="canonical" href="https://www.ibcstudio.com/travelhphoto"/>
    ...
    <section className="page-header" data-background={bgimg}>
           ...
           <div className="container">
               <div className="page-header-content text-center">
                   <h1 className="title">TRAVEL TOURISM & HOTEL Photography</h1>
                   <h4 className="sub-title"><a className="home" href="/home">Home </a><span></span><a className="inner-page" href="/modalphoto">TRAVEL TOURISM & HOTEL Photography</a></h4>
               </div>
           </div>
       </section>
      {/*page-header */}
      ...
      <div className="row pt-30 pb-200">
