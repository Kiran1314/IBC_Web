...
import Gallery from '../Components/PhotoGallery/PartiesPhoto'
...
export default function PartiesGphoto() {
  return (
    <>
    <Header/>
    <Seo
      ...
      />
      <link rel="canonical" href="https://www.ibcstudio.com/parties"/>
    ...
    <section className="page-header" data-background={bgimg}>
           ...
           <div className="container">
               <div className="page-header-content text-center">
                   <h1 className="title">Parties & Wedding Photography</h1>
                   <h4 className="sub-title"><a className="home" href="/home">Home </a><span></span><a className="inner-page" href="/modalphoto">Parties & Wedding Photography</a></h4>
               </div>
           </div>
       </section>
      {/*page-header */}
