...
import Gallery from '../Components/PhotoGallery/StillcoveragePhoto'
...
export default function StillcovGPhoto() {
  return (
    <>
    <Header/>
    <Seo
      ...
      />
      <link rel="canonical" href="https://www.ibcstudio.com/stilcov"/>
    ...
    <section className="page-header" data-background={bgimg}>
           ...
           <div className="container">
               <div className="page-header-content text-center">
                   <h1 className="title">Still Coverage</h1>
                   <h4 className="sub-title"><a className="home" href="/">Home </a><span></span><a className="inner-page" href="/stilcov">Still Coverage</a></h4>
               </div>
           </div>
       </section>
      {/*page-header */}
