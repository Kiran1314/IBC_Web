...
import Gallery from '../Components/PhotoGallery/IndustPhoto'
...
export default function IndustGPhoto() {
  return (
    <>
    <Header/>
    <Seo
      ...
      />
      <link rel="canonical" href="https://www.ibcstudio.com/industphoto"/>
    ...
    <section className="page-header" data-background={bgimg}>
           ...
           <div className="container">
               <div className="page-header-content text-center">
                   <h1 className="title">Industrial Photography</h1>
                   <h4 className="sub-title"><a className="home" href="/home">Home </a><span></span><a className="inner-page" href="/industphoto">Industrial Photography</a></h4>
               </div>
           </div>
       </section>
      {/*page-header */}
      ...
      <div className="row pt-40 pb-200">
