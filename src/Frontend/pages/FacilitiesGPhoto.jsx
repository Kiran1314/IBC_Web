...
import Gallery from '../Components/PhotoGallery/FacilitiesPhoto'
...
export default function FacilitiesGphoto() {
  return (
    <>
    <Header/>
    <Seo
    ...
    <section className="page-header" data-background={bgimg}>
           ...
           <div className="container">
               <div className="page-header-content text-center">
                   <h1 className="title">Facilities Photography</h1>
                   <h4 className="sub-title"><a className="home" href="/home">Home </a><span></span><a className="inner-page" href="/facilities">Facilities Photography</a></h4>
               </div>
           </div>
       </section>
      {/*page-header */}
