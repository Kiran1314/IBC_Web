...
import Gallery from '../Components/PhotoGallery/SchoolsPhoto'
...
export default function SchoolsGphoto() {
  return (
    <>
    <Header/>
    <Seo
      ...
      />
      <link rel="canonical" href="https://www.ibcstudio.com/schools"/>
    ...
    <section className="page-header" data-background={bgimg}>
           ...
           <div className="container">
               <div className="page-header-content text-center">
                   <h1 className="title">Schools & Centers Photography</h1>
                   <h4 className="sub-title"><a className="home" href="/home">Home </a><span></span><a className="inner-page" href="/schools">Schools & Centers Photography</a></h4>
               </div>
           </div>
       </section>
      {/*page-header */}
