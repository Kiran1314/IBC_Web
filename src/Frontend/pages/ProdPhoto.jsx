...
import Gallery from '../Components/PhotoGallery/ProductGallery'
...
export default function ProdPhoto() {
  return (
    <>
    <Header/>
    <Seo
      ...
      />
      <link rel="canonical" href="https://www.ibcstudio.com/prodphoto"/>
     ...
     <section className="page-header" data-background={bgimg}>
            ...
            <div className="container">
                <div className="page-header-content text-center">
                    ...
                    <h4 className="sub-title"><a className="home" href="/home">Home </a><span></span><a className="inner-page" href="/prodpohto"> Product Photography</a></h4>
                </div>
            </div>
        </section>
       {/*page-header */}
