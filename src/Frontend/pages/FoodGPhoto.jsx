...
import Gallery from '../Components/PhotoGallery/FoodPhoto'
...
export default function FoodGPhoto() {
  return (
    <>
    <Header/>
    <Seo
      ...
      />
      <link rel="canonical" href="https://www.ibcstudio.com/foodphoto"/>
     ...
     <section className="page-header" data-background={bgimg}>
            ...
            <div className="container">
                <div className="page-header-content text-center">
                    <h1 className="title">Product Photo</h1>
                    <h4 className="sub-title"><a className="home" href="/home">Home </a><span></span><a className="inner-page" href="/foodphoto"> Food Photography</a></h4>
                </div>
            </div>
        </section>
       {/*page-header */}
