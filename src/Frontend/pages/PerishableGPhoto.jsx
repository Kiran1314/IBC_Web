...
import Gallery from '../Components/PhotoGallery/PerishablePhoto'
...
export default function PerishableGPhoto() {
  return (
    <>
    <Header/>
    <Seo
      ...
      />
      <link rel="canonical" href="https://www.ibcstudio.com/perishable"/>
    ...
    <section className="page-header" data-background={bgimg}>
           ...
           <div className="container">
               <div className="page-header-content text-center">
                   <h1 className="title">Perishable Products Photography</h1>
                   <h4 className="sub-title"><a className="home" href="/home">Home </a><span></span><a className="inner-page" href="/perishable">Perishable Products Photography</a></h4>
               </div>
           </div>
       </section>
      {/*page-header */}
      ...
      <div className="row pt-50 pb-200">
