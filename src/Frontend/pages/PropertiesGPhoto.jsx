...
import Gallery from '../Components/PhotoGallery/PropertiesPhoto'
...
export default function PropertiesGphoto() {
  return (
    <>
    <Header/>
    ...
    <Seo
      ...
      />
      <link rel="canonical" href="https://www.ibcstudio.com/properties"/>
    ...
    <section className="page-header" data-background={bgimg}>
           ...
           <div className="container">
               <div className="page-header-content text-center">
                   <h1 className="title">Properties Photography</h1>
                   <h4 className="sub-title"><a className="home" href="/home">Home </a><span></span><a className="inner-page" href="/properties">Properties Photography</a></h4>
               </div>
           </div>
       </section>
      {/*page-header */}
